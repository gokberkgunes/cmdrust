...
fn bustle_stdin() -> Result<()> {
    run_stdin(BUSTLE, &["-"], "tests/expected/the_bustle.txt.stdin.out")
}
...
#[test]
fn bustle() -> Result<()> {
    run(&[BUSTLE], "tests/expected/the_bustle.txt.out")
}

// --------------------------------------------------
#[test]
fn bustle_n() -> Result<()> {
    run(&["-n", BUSTLE], "tests/expected/the_bustle.txt.n.out")
}

// --------------------------------------------------
#[test]
fn bustle_b() -> Result<()> {
    run(&["-b", BUSTLE], "tests/expected/the_bustle.txt.b.out")
}
